 ...
 * when a user logs out. It expects an UserDTO object and updates the user
...
public class UserLoggedOutHandler implements StompFrameHandler {
    ...
    public void handleFrame(StompHeaders headers, @Nullable Object payload) {
        ...
        mainMenuPresenter.userLoggedOut(user);
    }
